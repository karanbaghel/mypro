  ...
  return (
    <>
      <div className="vegeta">
        <h3>Find institutes in popular cities</h3>
        <div className="multibtn2">
          <button onClick={myfunk} className="btn70">Delhi</button>
          <button onClick={myfunk} className="btn70">Jaipur</button>
          <button onClick={myfunk} className="btn70">patna</button>
          <button onClick={myfunk} className="btn70">Kanpur</button>
          <button onClick={myfunk} className="btn70">Faridabad</button>
          <button onClick={myfunk} className="btn70">Faridabad</button>
          <button onClick={myfunk} className="btn70">Faridabad</button>
          <button onClick={myfunk} className="btn70">Faridabad</button>
          <button onClick={myfunk} className="btn70">Faridabad</button>
          ...
          <button onClick={myfunk} className="btn70">Faridabad</button>
          <button onClick={myfunk} className="btn70">Faridabad</button>
          <button onClick={myfunk} className="btn701"> +10More</button>

        </div>
      </div>

      <div className="box4">
                <h3>Top Institute Reviews
 </h3>
                <h5>Student reviews and feedbacks about their institutes
