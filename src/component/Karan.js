    ...
    return (
        <>
            ...
            <div className="box4">
                ...
                <h5>Newly launched courses by institutes which students are loving</h5>
...
//                 {/* <div className="multibtn">
//           <button className="btn70">UPSC</button>
//           <button className="btn70">SCC</button>
//           <button className="btn70">JEE</button>
//           <button className="btn70">NEET</button>
//           <button className="btn70">Python</button>
//           <button className="btn70">Bank</button>
//           <button className="btn70">Medical</button>
//           <button className="btn70">Defence</button>
//         </div> */}
//                 <div className="move">
...
//                                     <h5>
//                                         {" "}
//                                         * Course will be deliverd by Manikant singh in online mode
//                                     </h5>
//                                     <h5>
//                                         <span>
